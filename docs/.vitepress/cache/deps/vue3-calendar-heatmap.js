...
// node_modules/.pnpm/vue3-calendar-heatmap@2.0.5_tippy.js@6.3.7_vue@3.5.12_typescript@5.7.2_/node_modules/vue3-calendar-heatmap/dist/vue3-calendar-heatmap.es.js
var ae = Object.defineProperty;
var re = (e, t, a) => t in e ? ae(e, t, { enumerable: true, configurable: true, writable: true, value: a }) : e[t] = a;
...
var he = defineComponent({
  ...
  emits: ["dayClick"],
  setup(e) {
    const t = n.SQUARE_SIZE / 5, a = n.SQUARE_SIZE + t, s = Math.ceil(n.SQUARE_SIZE * 2.5), d = a * 3, o = n.SQUARE_SIZE + n.SQUARE_SIZE / 2, h = n.SQUARE_SIZE + n.SQUARE_SIZE / 2, E = `translate(${s}, ${o})`, I = ref(null), U = ref(/* @__PURE__ */ new Date()), S = ref(new n(e.endDate, e.values, e.max)), p = ref(0), T = ref(0), F = ref("0 0 0 0"), W = ref("0 0 0 0"), k = ref(""), L = ref(""), b = ref(""), D = ref({}), O = ref(e.rangeColor || (e.darkMode ? n.DEFAULT_RANGE_COLOR_DARK : n.DEFAULT_RANGE_COLOR_LIGHT)), { values: K, tooltipUnit: H, tooltipFormatter: z, noDataText: V, max: q, vertical: B, locale: J } = toRefs(e), c = /* @__PURE__ */ new Map();
    let g;
    function Y() {
      c.clear(), g ? g.setInstances(Array.from(c.values())) : g = createSingleton(Array.from(c.values()), {
        overrides: [],
    ...
    watch([toRef(e, "rangeColor"), toRef(e, "darkMode")], ([r, f]) => {
    ...
    }, { immediate: true }), watch([p, T], ([r, f]) => F.value = ` 0 0 ${r} ${f}`, { immediate: true }), watch([p, T, O], ([r, f, C]) => {
      b.value = B.value ? `translate(${s + a * n.DAYS_IN_WEEK}, ${o})` : `translate(${r - a * C.length - 30}, ${f - h})`;
    }, { immediate: true }), watch(J, (r) => D.value = r ? { ...n.DEFAULT_LOCALE, ...r } : n.DEFAULT_LOCALE, { immediate: true }), watch(O, (r) => W.value = `0 0 ${n.SQUARE_SIZE * (r.length + 1)} ${n.SQUARE_SIZE}`, { immediate: true }), watch(
      [K, H, z, V, q, O],
      () => {
        S.value = new n(e.endDate, e.values, e.max), c.forEach((r) => r.destroy()), nextTick(Y);
      }
    ), onMounted(Y), onBeforeUnmount(() => {
      ...
      if (g && r.target && r.target.classList.contains("vch__day__square") && r.target.dataset.weekIndex !== void 0 && r.target.dataset.dayIndex !== void 0) {
        ...
        if (!isNaN(f) && !isNaN(C)) {
          ...
          if (Q) {
            ...
            Z ? Z.setContent(Q) : Z || (c.set(r.target, tippy_esm_default(r.target, { content: Q })), g.setInstances(Array.from(c.values())));
          }
        }
      }
    }
...
var Re = ["transform"];
var De = ["x"];
var me = ["rx", "ry", "width", "height", "x", "y"];
var Ie = ["x", "y"];
var Ue = ["transform"];
var pe = ["transform"];
var Te = ["rx", "ry", "transform", "width", "height", "data-week-index", "data-day-index", "onClick"];
var Oe = { class: "vch__legend" };
var we = { class: "vch__legend-left" };
var Ce = { class: "vch__legend-right" };
var ke = { class: "vch__legend" };
var Le = ["viewBox", "height"];
var Qe = { class: "vch__legend__wrapper" };
var Ze = ["rx", "ry", "width", "height", "x"];
function $e(e, t, a, s, d, o) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass({ vch__container: true, "dark-mode": e.darkMode })
  }, [
    (openBlock(), createElementBlock("svg", {
      ...
      createBaseVNode("g", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(e.heatmap.firstFullWeekOfMonths, (h, E) => (openBlock(), createElementBlock("text", {
          class: "vch__month__label",
          key: E,
          x: e.getMonthLabelPosition(h).x,
          y: e.getMonthLabelPosition(h).y
        }, toDisplayString(e.lo.months[h.value]), 9, ce))), 128))
      ], 8, Se),
      createBaseVNode("g", {
      ...
      e.vertical ? (openBlock(), createElementBlock("g", {
        ...
        createBaseVNode("text", {
          ...
          y: "8"
        }, toDisplayString(e.lo.less), 9, De),
        (openBlock(true), createElementBlock(Fragment, null, renderList(e.curRangeColor, (h, E) => (openBlock(), createElementBlock("rect", {
          key: E,
          rx: e.round,
          ry: e.round,
          style: normalizeStyle({ fill: h }),
        ...
        }, toDisplayString(e.lo.more), 9, Ie)
      ], 8, Re)) : createCommentVNode("", true),
      createBaseVNode("g", {
        class: "vch__year__wrapper",
        transform: e.yearWrapperTransform,
        onMouseover: t[0] || (t[0] = (...h) => e.initTippyLazy && e.initTippyLazy(...h))
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(e.heatmap.calendar, (h, E) => (openBlock(), createElementBlock("g", {
          class: "vch__month__wrapper",
          key: E,
          transform: e.getWeekPosition(E)
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(h, (I, U) => (openBlock(), createElementBlock(Fragment, { key: U }, [
            I.date < e.now ? (openBlock(), createElementBlock("rect", {
              key: 0,
              ...
              width: e.SQUARE_SIZE - e.SQUARE_BORDER_SIZE,
              height: e.SQUARE_SIZE - e.SQUARE_BORDER_SIZE,
              style: normalizeStyle({ fill: e.curRangeColor[I.colorIndex] }),
              "data-week-index": E,
              "data-day-index": U,
              onClick: (S) => e.$emit("dayClick", I)
            }, null, 12, Te)) : createCommentVNode("", true)
          ], 64))), 128))
        ], 8, pe))), 128))
      ], 40, Ue)
    ], 8, ve)),
    createBaseVNode("div", Oe, [
      renderSlot(e.$slots, "legend", {}, () => [
        createBaseVNode("div", we, [
          renderSlot(e.$slots, "vch__legend-left")
        ]),
        createBaseVNode("div", Ce, [
          renderSlot(e.$slots, "legend-right", {}, () => [
            createBaseVNode("div", ke, [
              createBaseVNode("div", null, toDisplayString(e.lo.less), 1),
              e.vertical ? createCommentVNode("", true) : (openBlock(), createElementBlock("svg", {
                key: 0,
              ...
              createBaseVNode("div", null, toDisplayString(e.lo.more), 1)
            ])
          ])
        ])
      ])
...
//# sourceMappingURL=vue3-calendar-heatmap.js.map
