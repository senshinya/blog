...
const en: MessageSchema = {
	...
	post: {
		...
		licenseName: 'Attribution-NonCommercial-ShareAlike 4.0 International',
		licenseUrl: 'https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en',
		share: 'Share as text',
	...
	widget: {
		...
		blogLog: {
			title: 'Changelog',
			aiDisclosure: 'Added AI authorship disclosure',
