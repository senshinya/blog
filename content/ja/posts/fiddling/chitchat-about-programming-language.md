...
seoTitle: "プログラミング言語設計：型システム、ランタイムと実装"
...
categories: [fiddling]
tags: ["プログラミング言語設計","型システム","コンパイラ設計","RISC-V"]
image: "https://blog-img.774352199.xyz/uO420B.webp"
seoDescription: "架空の言語を設計する流れで、コードの実行環境、型、配列、引数渡し、継承、ジェネリクスを考察。CやJava、Goなどの実装を例に、言語機能の仕組みと設計上の選択を説明します。"
---
