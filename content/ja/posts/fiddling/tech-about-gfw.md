...
このテストベッドが公開した論文[計算グリッド環境における複数拠点協調に基づくジョブレベルのタスクスケジューリングアルゴリズム](https://dds.sciengine.com/cfs/files/pdfs/1674-5973/LcNrPPSfzafrc3Pmn.pdf)によると、2005年時点の構成は次のとおりです。
