...
经过以上的操作，就能保证 MYDB 在单线程下的恢复性。那么多线程的情况呢？我们来考虑下面的两种情况。
...
> 出现这种问题的原因，归根结底是因为我们的日志太过简单，仅仅记录了“前相”和“后相”，并单纯地依靠“前相”进行 undo，依靠“后相”进行 redo。这种简单的日志方式和恢复方式，并不能涵盖住所有数据库操作形成的语义
